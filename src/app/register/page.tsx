      ...
      <div className="relative w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden flex">
        ...
        <div className="w-full sm:w-[70%] p-8 sm:p-10">
          ...
          <p className="text-slate-500 text-sm mb-8 font-bn">
            হাজার হাজার ইঞ্জিনিয়ারদের সাথে যোগ দিন এবং ইলেকট্রিক্যাল কমপ্লায়েন্স স্ট্যান্ডার্ড আয়ত্ত করুন।
          </p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-9 pr-3 py-2.5 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-blue/20 focus:border-brand-blue text-sm font-bn"
                />
              </div>
            </div>
