...
const categoryColors: Record<string, { bg: string; text: string; border: string; accent: string }> = {
  general: { bg: "bg-brand-blue/10", text: "text-brand-blue", border: "border-brand-blue/20", accent: "bg-brand-blue" },
  bnbc: { bg: "bg-brand-green/10", text: "text-brand-green", border: "border-brand-green/20", accent: "bg-brand-green" },
  nfpa: { bg: "bg-brand-gold/10", text: "text-brand-gold", border: "border-brand-gold/20", accent: "bg-brand-gold" },
  rsc: { bg: "bg-brand-red/10", text: "text-brand-red", border: "border-brand-red/20", accent: "bg-brand-red" },
  electrical: { bg: "bg-brand-purple/10", text: "text-brand-purple", border: "border-brand-purple/20", accent: "bg-brand-purple" },
};
      ...
      >
        ...
        <div
          className={cn(
            ...
            isOpen ? colors.accent : "bg-slate-200 group-hover:bg-slate-300"
          )}
        />
        ...
        <div className="flex-1 min-w-0">
          <span
            className={cn(
              ...
              isOpen ? "text-brand-navy" : "text-slate-700 group-hover:text-brand-navy"
            )}
          >
            {faq.question}
          </span>
...
export default function FaqSection() {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-white via-brand-lightgray/30 to-white relative overflow-hidden">
      {/* Decorative background */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-brand-blue/[0.02] rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-brand-gold/[0.03] rounded-full blur-3xl" />
        <div
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-brand-gold/10 text-brand-gold rounded-full px-4 py-1.5 mb-4">
          ...
          <p className="mt-3 text-brand-gray font-bn text-lg max-w-xl mx-auto">
          ...
          <div className="flex items-center gap-1 overflow-x-auto pb-1 scrollbar-hide relative">
            ...
            {categories.map((cat, i) => {
              ...
              return (
                ...
                >
                  <Icon className={cn("h-3.5 w-3.5", isActive && "text-brand-navy")} />
                  <span>{cat.label}</span>
                  <span
                    className={cn(
        ...
        <div className="flex items-center justify-between mb-5">
          <p className="text-sm text-slate-500 font-bn">
            <span className="font-semibold text-brand-navy">{filteredFaqs.length}</span>{" "}
        ...
        {filteredFaqs.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-slate-500 font-bn text-lg mb-1">No questions found</p>
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex flex-col sm:flex-row items-center gap-4 bg-brand-navy/[0.03] rounded-2xl px-8 py-6 border border-brand-navy/[0.06]">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-slate-500 font-bn text-xs">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-brand-navy text-white font-semibold text-sm px-5 py-2.5 rounded-lg hover:bg-brand-navy/90 transition-colors font-bn shrink-0"
            >
              Contact Us
